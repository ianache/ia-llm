...
@measure
def question_and_answer(llm, retriever, question):
    TEMPLATE = """
    ...
    """
    template = """Responder la pregunta basada en el siguiente contexto:
    {context}
...
def main():
    ...
    while True:
        ...
        if question == 'salir':
            break
        question_and_answer(ollama, retriever, question)
